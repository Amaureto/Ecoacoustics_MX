...
biblio-style: apalike #set the bibliography style to use
...
Acoustic monitoring offers an efficient and effective method to assess biodiversity [@Riede1993]. Automated Recording Digital Systems (ADRS) constitute the fundamental equipment to record the sound environment at a specific site [@Acevedo2006]; among the most important advantages it works to detect rara or secretive species, allows to carry out a more systematic and less intrusive sampling during extended periods of time. Although there is a variety of acoustic sensors, it is necessary to improve the technique to achieve a greater representation of biodiversity. To know the resolution of the acoustic sampling is specially important for those studies estimating abundance and density in occupancy modelling and very useful to predict and spatialize the patterns of acoustic activity. The probability of detecting an animal typically depends on its distance to the observer or the sensor [@Marques2013]. However, few studies have mentioned explicitly about the maximum range or the area covered by the recording devices [@Llusia2012].

The reaching distance of the devices delimits the *detection space* of the soundscape or the acoustic community of interest. The theory says that, when sound spreads nearly hemispherically, its intensity decays like 1/R^2^, where R is the distance from the source [@Fletcher2014]. This phenomenon of decreasement in sound energy, which is measured in decibels (dB) as amplitude, is called attenuation. The sound attenuation phenomenon is due to three main factors: distance spreading, absorption of the medium (heat conduction, viscosity or losses due to molecular relaxation), and other phenomena of wave dispersion (reflection, refraction, diffraction and absorption by changes in the impedance of the medium) [@Sueur2018]. The absorption of the medium and the dispersion phenomena are difficult to model since they depend on several parameters such as frequency, humidity, temperature, pressure and physical properties of the obstacles that generate dispersion; on the contrary, spreading losses are easier to predict if there is a reference intensity (*iref*) and a reference distance (*dref*) [@Sueur2018].
...
Therefore, the evaluation of the recording range is a fairly complex task, since many factors are involved in the transmission of the sounds, from the acoustic nature of the signal of interest and the geophysical attributes of the site, to the characteristics and configuration of the recording equipment.

Most of the studies working with ARDS do not refer to the spatial extent of recording devices, but all of them consider that sampling units should be spaced far enough apart to minimize acoustic overlap, which means not recording the same individuals. But what is enough? They separarate recorders but apparently not based in any experimental study; the theoretical detection space is not mentioned even in user guides or in acoustic monitoring protocols.

|Author|Distance between sampling units (recording points)|
|:----|:--------------------|
|@Alvarez-Berrios2016 | by more than 70 m | 
|@Deichmann2017 | spaced 200 m |
|@Depraetere2012 | at 300 m | 
|@Farina2014c | at 80 m |
|@Farina2014 | at 25 m |
|@Frommolt2014 |more than 150 m |
|@Gasc2013 |by 200 m  |
|@Goyette2011 | more than 300 m |
|@Lellouch2014  | at 300 m | 
|@Mazaris2009 | at 350 m | 
|@ParkerIII1991 | at 500 m 
|@Pieretti2015 |  300 m |
|@Pieretti2011 | at 100 m | 
|@Sankupellay2015 | from 200 to 300 m|
|@Shirose1997 | 500m |
|@Tegeler2012 | 250-400m | 

Some studies have compared traditional sampling methods (visual encounter and auditory surveys) considering, for example, 50 x 2-m transects  versus automated recording, the latter with a greater efficiency and detection range in a forested wetland @Acevedo2006. On the other hand, @Farina2014 detected variability of the soundscape at only 25m and assumed confirming the adequacy of this sampling scale despite their closeness.

Other studies have evaluated the sampling area for some species, for example  
@Aide2013 mentioned that based on informal experiments, ARBIMON recording systems can detect the common coqui frog (*Eleutherodactylus coqui*) in a forest habitat up to approximately 50 m, suggesting for this species the sampling area would be 
approximately 1 ha.  

In this project, we aimed to evaluate through an experimental approach, the detection range of the omnidirectional microphone integrated into the automatic recorder *SWIFT*. In particular, we identified the maximum distance at which all the sounds of animals of different frequencies are captured. We studied the transmission of each signal of interest according to its frequency category and its expected attenuation. We analyzed the effect of the distance, the terrain slope, the canopy cover and the density of arboreal vegetation on the loss of the signals. Since the intensity of the sounds decreases with distance and this attenuation is favoured in the presence of barriers such as vegetation, we expected a greater loss of amplitude occurring in closer distances and in sites with higher canopy coverage and tree density. On the other hand, given the inverse relationship between the distance and the frequency of the signal, we expect that the sounds with high dominant frequency will be attenuated in closer distances. This study has applications in the field of Ecoacoustics research, which studies the ecological relevance of the wildlife sounds. 
...
We carried an experiment to know the maximum recording distance (m), this consisted of reproducing a and re-recording a soundtrack containing prerecorded animals contrasting in their dominant frequency (that one with the highest energy). The detection space was considered as the reach distance from the signal source, in which its amplitude remains above a minimum detection threshold [@Brenowits1982]. 
...
# 1.Open TIF file
#tiff("espectrog.tif", width = 2400, height = 1400, units = "px")
...
knitr::include_graphics("espectrog.tif") #show spectrogram
```
...
The maximum average distance at which most of the animal sounds of different frequencies were detected was 80 m. Knowing that omnidirectional microphones sample sounds with more or less equal efficiency in all directions, the detection range area is aproximately 0.64 ha.  

In some researches have considering moving recorders to cover a more extended area [@Bardeli2010].

As we expected, the high-frequency signals resulted in greater loss as the distance increases, one of the high-frequency sounds were attenuated and lost at 40m, these signals contain less pressure or less energy and tend to more easily degrade with obstacles. The foliage (increased leaf number density, leaf width and leaf thickness) reduces sound transmission specially at the higher frequencies and the ground attenuates considerable amounts of acoustic energy at lower frequencies and diverse forests attenuate nearly the same amount of sound [@Aylor1972].
...
The attenuation estimated by theory which considered distance had more relevance than vegetation and slope in estimating the the detection distance of the recorder which is especially relevant for studies in which it is intended to record the sound remotely and autonomously. On the contrary, it was not the objective of this project to evaluate the transmission of sounds, which could require another type of experimental design.

In the wildlife, animals emit vocalizations at different heights and some of them are moving or changing their orientation when calling. 

We considered it is important to mention the distance between recording stations.
...
<span style = "color:red">**_Other considerations:_**</span>
...
There was no reference control signal (pure tone of 1kHz at 94 dB SPL which is the pressure of 1 Pascal), based on this normalization would be performed.

Review the frequency response of the horn, because it would amplify certain frequencies further.
